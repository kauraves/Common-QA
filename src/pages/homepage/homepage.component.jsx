...
class HomePage extends React.Component {
    ...
    this.state = {
      list:[
        // Temporary test data
        {
          ...
          "questionText": "id sapien. Cras dolor dolor, tempus non, lacinia at, iaculis",
          "questionID": 101,
          "votes": 27
        },
        {
          ...
          "questionText": "auctor non, feugiat nec, diam. Duis mi enim, condimentum eget, volutpat ornare, facilisis",
          "questionID": 102,
          "votes": 22
        },
        {
          ...
          "questionText": "nisl sem, consequat nec, mollis vitae, posuere at, velit. Cras lorem lorem, luctus ut, pellentesque eget, dictum placerat, augue. Sed molestie. Sed id",
          "questionID": 103,
          "votes": 8
        },
        {
          ...
          "questionText": "Donec felis orci, adipiscing non, luctus sit amet, faucibus ut, nulla.",
          "questionID": 104,
          "votes": 29
        },
        {
          ...
          "questionText": "dignissim tempor arcu. Vestibulum ut eros non enim commodo hendrerit. Donec porttitor tellus",
          "questionID": 105,
          "votes": 30
        }
      ] 
  ...
  render() {
    ...
    let questionItems = this.state.list.map(questionItem =>
      <tr>
        <td>
          <Votes votes={questionItem.votes} questionID={questionItem.questionID}
          upvoteQuestion={this.upvoteQuestion} downvoteQuestion={this.downvoteQuestion}/>
        </td>
        <td>
          <QuestionSummary question={questionItem.questionTitle}
